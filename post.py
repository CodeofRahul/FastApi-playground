...
class Patient(BaseModel):
    ...
    weight: Annotated[float, Field(..., gt=0, description='Weight of the patient n kgs')]
...
def view_patient(patient_id: str = Path(..., description= 'ID of the patient n th DB', example='P001')):
